...
public class Interactions {
    ...
    public static void printWelcomeMessage() {
        ...
        Logging.logUI("1. Create a Topic > Prompts user for topic name, creates directory", new String[]{Logging.ITALIC});
        Logging.smartHorizontalLine();
        Logging.logUI("2. Select a Topic > Gives a list of topics, select one to run analysis", new String[]{Logging.ITALIC});
        Logging.smartHorizontalLine();
        Logging.logUI("3. Add an Article > Prompts user for article URL (or file name), downloads article", new String[]{Logging.ITALIC});
        Logging.smartHorizontalLine();
        Logging.logUI("4. Remove an Article > Select topic, then prompts user to remove an article", new String[]{Logging.ITALIC});
        Logging.smartHorizontalLine();
